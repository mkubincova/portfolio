...
<article
	class="flex justify-center pt-[calc(46px+theme(padding.3))] md:pt-[calc(52px+theme(padding.3))]"
	id="home"
	on:mousemove={moveEyes}
>
	<section class="mt-16">
		<h1 class="sm:text-7xl">Hi, <br />I'm Magda</h1>
		<p class="text-xl md:text-2xl">a full-stack web developer.</p>
		<div class="flex flex-wrap gap-2 mt-3">
			<Button element="a" variant="solid" href="#projects">Check out my work</Button>
