	...
	<section class="flex flex-col md:flex-row items-center justify-center">
		<div>
			...
			<p class="text-base max-w-prose">
				...
				Originally on my way to become an economist, I was introduced to coding by chance during an
				internship and stuck with ever since. I'm passionate about creating web applications and
				after a few years of working mainly with front-end, I would like to expand my skillset to
				<strong>full-stack development.</strong>
				With a few online courses and small projects under my belt, I looking for a job that would allow
				me to further improve in this and other areas.
			</p>
			<a href="/books/a-great-book.pdf" target="_blank" class="btn btn-primary mt-3">Dowload CV</a>
		</div>
